...
// This class is going to hold a JSON response from grabbing weather via API
// The names and types of the variables in it MUST match the names and type of the variables in the returned JSON object
